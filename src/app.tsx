          ...
          {isGuestsInputOpen && (
            <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
              ...
              <button type="button" onClick={openGuestModal} className='flex items-center gap-2 flex-1 text-left'>
                ...
                <span className="text-zinc-400 txt-lg flex-1">Quem estará na viagem?</span>
              </button>
        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center">
          <div className="w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900">
            ...
            <div className="flex flex-wrap gap-2 mt-2">
              {/*se utiliza key para saber elemento está respondedo o item do array*/}
            ...
            <div className="w-full h-px bg-zinc-800 mt-2 mb-2" />
