                ...
                <div className="w-80 space-y-6">
                        ...
                        <div className="space-y-5">
                            <div className="flex items-center justify-between">
                                <div className="space-y-1.5">
                                    <span className="block font-medium text-zinc-100 truncate">Reserva do AirBnB</span>
                            ...
                            <div className="flex items-center justify-between">
                                <div className="space-y-1.5">
                                    <span className="block font-medium text-zinc-100 truncate">Regras da casa</span>
                                    <a href="#" className="block text-sm text-zinc-400 truncate hover:text-zinc-200">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-5">
                            <div className="flex items-center justify-between">
                                <div className="space-y-1.5">
                                    <span className="block font-medium text-zinc-100 truncate">Jéssica White</span>
                            ...
                            <div className="flex items-center justify-between">
                                <div className="space-y-1.5">
                                    <span className="block font-medium text-zinc-100 truncate">Dra. Pacocha</span>
                                    <span className="block text-sm text-zinc-400 truncate">
